...
suite('mml_builder', function() {
  ...
  test('store a good style with version 2.0.2 converting and retrieve it', function(done) {
    ...
    var style_converted = "#t { marker-width:6; [mapnik-geometry-type=1] { marker-placement:point; marker-type:ellipse; } [mapnik-geometry-type>1] { marker-placement:line; marker-type:arrow; marker-clip:false; } }";
    var mml_store = new grainstore.MMLStore(redis_opts, {mapnik_version: '2.1.0'});
  ...
  test('resetStyle can re-write converted versions', function(done) {
    ...
    var style_converted = "#t { marker-width:4; [mapnik-geometry-type=1] { marker-placement:point; marker-type:ellipse; } [mapnik-geometry-type>1] { marker-placement:line; marker-type:arrow; marker-clip:false; } }";
