...
suite('mml_transformer', function() {
  ...
  test('add missing version, no transform', function() {
    ...
    var t = new MMLTransformer('2.0.0', '2.0.0');
    var s = t.transform('#t { marker-width:10; marker-height:5}');
    assert.equal(s, "version: '2.0.0'; #t { marker-width:10; marker-height:5}");
  ...
  test('adapt version, no transform', function() {
    ...
    // From 2.0.0 to 2.1.0
    var s = t.transform("version: '2.0.0'; #t {}");
    assert.equal(s, "version: '2.1.0'; #t {}");
...
"version: '2.1.0'; #t { marker-width:20; \nmarker-height:40; }; }"
  ...
  // Adapts marker width and height, from 2.0.0 (missing) to 2.1.0
  test('2.0.0 (missing) to 2.1.0, markers', function() {
    var t = new MMLTransformer('2.0.0', '2.1.0');
    var s = t.transform(
"#tab[zoom=1] { marker-width:10; marker-height:20; }\n#tab[zoom=2] { marker-height:'6'; marker-width: '7'; }"
    );
    assert.equal(s,
...
"version: '2.1.0'; #tab { marker-height:20; marker-width:40; }"
  ...
  // Adapts marker width and height, from 2.0.0 (expliclit) to 2.1.0
  test('2.0.0 (explicit) to 2.1.0, markers', function() {
    var t = new MMLTransformer('2.1.0', '2.1.0');
    var s = t.transform(
"version: '2.0.0'; #tab { marker-height: 10; marker-width: 20; }"
    );
    assert.equal(s,
"version: '2.1.0'; #tab { marker-height:20; marker-width:40; }"
    );
