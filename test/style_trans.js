...
describe('style_trans', function () {
    // before(function() { });

    // No change from 2.0.0 to ~2.0.2
    it('2.0.0 to ~2.0.2', function () {
    ...
    it('2.0.2 to 2.1.0, markers', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.0, more markers', function () {
    ...
    it('2.0.0 to 2.1.0, markers dependent on filter', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.0, markers', function () {
        var s = t.transform(
            "#tab[zoom=1] { marker-width:10; marker-height:20; }\n#tab[zoom=2] { marker-height:'6'; marker-width: \"7\"; }",
            '2.0.0', '2.1.0'
        );
        ...
        e = '#tab { marker-width:4; ["mapnik::geometry_type"=1] { marker-placement:point; marker-type:ellipse; } ["mapnik::geometry_type">1] { marker-placement:line; marker-type:arrow; marker-transform:scale(.5, .5); marker-clip:false; } }';
        assert.equal(s, e);
    ...
    it('2.0.0 to 2.1.0, line clipping', function () {
        var s = t.transform(
            '#tab{ line-opacity:.5 }'
            , '2.0.0', '2.1.0'
        );
    ...
    it('2.0.0 to 2.1.0, line clipping, bug #37', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.0, polygon clipping', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.0, one line comments', function () {
        var s = t.transform(
            '#tab{ //polygon-fill:red;\n}'
            , '2.0.0', '2.1.0'
        );
    ...
    it('2.0.0 to 2.1.0, multiple one line comments', function () {
        var s = t.transform(
            '#tab{ //polygon-fill:red;\n //marker-type:ellipse;\n }'
            , '2.0.0', '2.1.0'
        );
    ...
    it('2.0.0 to 2.1.0, symbolizers hidden in one line comments', function () {
        var s = t.transform(
            '#tab{ //polygon-fill:red;\n line-opacity:1; }'
            , '2.0.0', '2.1.0'
        );
    ...
    it('2.0.0 to 2.1.0, symbolizers hidden in multiline line comments', function () {
        var s = t.transform(
            '#tab{ /* polygon-fill:\nred; */ line-opacity:1; }'
            , '2.0.0', '2.1.0'
        );
    ...
    it('2.0.0 to 2.1.0, missing semicolon', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.1, marker-multi-policy', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.0, no markers', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.0, arrow marker specified in outer block', function () {
        var s = t.transform(
    ...
    it('2.0.0 to 2.1.0, marker-opacity', function () {
        var s = t.transform(
    ...
    it('transform retains quotes in CartoCSS', function () {
        var s = t.transform("#t [t=\"ja'ja\\\"ja\"] {  }", '2.0.0', '2.1.0');
        var e = "#t [t=\"ja'ja\\\"ja\"] {  }";
        assert.equal(s, e);

        s = t.transform("#t [t='ja\\'ja\"ja'] {  }", '2.0.0', '2.1.0');
        e = "#t [t='ja\\'ja\"ja'] {  }";
        assert.equal(s, e);
    });

    it('2.1.1 to 2.2.0, mapnik-geometry-type', function () {
        var s = t.transform(
    ...
    it('2.1.1 to 2.1.0', function () {
        var e = null;
        try { t.transform('#t { }', '2.1.1', '2.1.0'); } catch (err) { e = err; }
        assert.ok(e);
        assert.ok(RegExp(/No CartoCSS transform path/).exec(e),
            'Unexpected exception message ' + e);
    });

    it('2.1.1 to 2.2.1', function () {
        var e = null;
        try { t.transform('#t { }', '2.1.1', '2.2.1'); } catch (err) { e = err; }
        assert.ok(e);
        assert.ok(RegExp(/No CartoCSS transform path/).exec(e),
            'Unexpected exception message ' + e);
    });
    ...
    it('layername replacement', function () {
