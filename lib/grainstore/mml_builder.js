    ...
    me.init = function(callback){
        ...
        Step(
            ...
            function getStyleAndXML(err, data){
                if (err) throw err;
                redis_client = data;
                // NOTE: we don't WATCH the store_key 
                //       for extended keys because 
                //       otherwise one test in our suite
                //       fails, but I still have to
                //       understand why !! TODO: fix this
                if ( ! extended_store_key ) {
                  redis_client.WATCH(store_key);
                }
            ...
            function setStore(err, compiled_XML){
                ...
                // the value of store_key changed since we
