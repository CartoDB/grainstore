...
var MMLBuilder = function(redis_pool, opts, optional_args, init_callback){
    ...
    // core variables
    if (!opts || !opts.hasOwnProperty('dbname') || !opts.hasOwnProperty('table'))
...
//console.log("Resolved mml: "); console.dir(mml);
    ...
    me.makeExtendedKey = function() {
      ...
      if ( style_override ) {
        md5.update(style_override);
        md5.update(style_version_override);
      }
      var key = base_store_key + '|' + md5.digest('hex');
      return key;
    }
