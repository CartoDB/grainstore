...
//                     Only effective when no 'table' is given.
//                     Can be 0 for no redis write.
...
var MMLBuilder = function(redis_pool, opts, optional_args, init_callback){
    ...
    var ttl = opts.hasOwnProperty('ttl') ? opts.ttl : 300; // 5 mins by default
...
// TODO: "related keys" concept was drop in 0.16, stop bothering about them...
console.log("WARNING: extended keys list was NOT empty (should eventually become so since grainstore 0.16)");
