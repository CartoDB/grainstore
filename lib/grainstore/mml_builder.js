...
var MMLBuilder = function(redis_pool, opts, optional_args, init_callback){
    ...
    me.processStyle = function(style){
      ...
      var version = got_version ? got_version[1] : '2.0.2';
      ...
      // Add or update version string, even if nothing got upgraded
      if ( got_version ) style = style.replace(re_ver, "version: '" + target_version + "'");
