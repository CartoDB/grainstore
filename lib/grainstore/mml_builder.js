var _      = require('underscore'),
    ...
    fs     = require('fs'),
    MMLTransformer = require('./mml_transformer')
;
...
var MMLBuilder = function(redis_pool, opts, optional_args, init_callback){
    ...
    me.processStyle = function(style){
      var missing_version = '2.0.2'; // TODO: make this configurable ?
      var transformer = new MMLTransformer(missing_version, target_mapnik_version);
