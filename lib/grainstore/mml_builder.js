...
var threadPool = poolModule.Pool({
    name     : 'mysql',
    create   : function(callback) {
        callback(null, fork(__dirname + '/carto_renderer_child.js'));
    },
