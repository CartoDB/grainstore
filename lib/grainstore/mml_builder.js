...
var MMLBuilder = function(redis_pool, opts, optional_args, init_callback){
    ...
    var default_style_version = extra_config.mapnik_version || '2.0.0'; // when unspecified
        ...
        Step(
            ...
            function renderBaseStyleOrDefaultOrOverride(err, data){
                ...
                if (_.isNull(data)){
                    ...
                    style_version = '2.0.0'; // TODO: change when grainstore_styles version changes...
                } else {
    ...
    me.setStyle = function(style, callback, version){
        var that = this
            , redis_client
            , compiled_XML;
        ...
        Step(
            ...
            function storeStyleAndXML(err, data){
                ...
                redis_client = data;
                if ( _.isNull(style_override) )  {
                  redis_client.SET(base_store_key, JSON.stringify({style: style, xml: compiled_XML, version: version}), this);
                } else {
    ...
    me.processStyle = function(style){
      var from = default_style_version;
      var to = target_mapnik_version;
      var t = new StyleTrans(); 
      return t.transform(style, from, to);
    };
    ...
    var style_version_override = opts.version ? opts.version : default_style_version;
