...
var debug = require('debug')('grainstore:mml-builder-worker');
var debugXml = require('debug')('grainstore:mml-builder-worker:xml');
...
MMLBuilderWorker.prototype.toXML = function(callback) {
    ...
    if (!this.options.use_workers) {
        return MMLBuilder.prototype.toXML.call(this, callback);
    }
